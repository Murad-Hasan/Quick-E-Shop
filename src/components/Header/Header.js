            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav>
                        ...
                        {
                            loggedInUser.displayName ? <Nav.Link style={{ fontWeight: "500", color:'#000' }}>{loggedInUser.displayName}</Nav.Link> : <Nav.Link as={Link} to='/login' style={{ fontWeight: "500" }}>LogIn</Nav.Link>
                        }
                    </Nav>
                </Navbar.Collapse>
            </Container>
